...
pairwise_logreg_dgv2.py(per-subset自前学習版)との違いは入力JSONのみ:
...
実行: docker exec opengait_container python /app/OpenGait/dgv2_analysis/pairwise_logreg_sustech.py
"""
import argparse
import itertools
import json
...
def main():
    ...
    out = os.path.join(HERE, "result_logreg_sustech.json")
